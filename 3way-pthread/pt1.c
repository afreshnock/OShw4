...
void getLineAndMax(char* line, int* max){
	int i = 0;
...
main() {
	...
	char* src_file = "~/../dan/625/wiki_dump.txt";

	bool deserialized = array_deserialize(src_file, char_array, STRING_SIZE, ARRAY_SIZE);
	//init_arrays();
	if(deserialized){
